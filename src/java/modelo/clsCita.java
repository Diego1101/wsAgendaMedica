...
public class clsCita {
    ...
    public ResultSet listarEspecialidades() throws SQLException{
        String consultaSql;
        Statement st;
    ...
    public ResultSet listarDoctores(int Esp) throws SQLException{
        String consultaSql;
        Statement st;
        consultaSql = "CALL stpListarDoctor("+Esp+");";
        st = (Statement) cnn.createStatement();
        rs = st.executeQuery(consultaSql);
        return rs;
    }
    
    public ResultSet agendarCita(int Paciente, int Doctor, int Hora, String Dia) throws SQLException{
        String consultaSql;
        Statement st;
        consultaSql = "CALL stpAgendarCita("+Paciente+","+Doctor+","+Hora+",'"+Dia+"');";
        st = (Statement) cnn.createStatement();
        rs = st.executeQuery(consultaSql);
        return rs;
    }
    
    public ResultSet registrarPaciente(String Usuario, String Contra, String Correo, String Nombre, String Apellidos, String Alergias) throws SQLException{
        String consultaSql;
        Statement st;
