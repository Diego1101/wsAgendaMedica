            ...
            <nav class="navbar navbar-expand-lg navbar fixed-top  navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="#Welcome">Agendar cita</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#Restaurant">Mis citas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#Menu">Mis datos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#Reservation">Iniciar sesion</a>
                        </li>
                    </ul>
                </div>
            </nav>
