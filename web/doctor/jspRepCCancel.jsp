<%-- 
    Document   : jspRepCCancel
    Created on : 24-oct-2019, 12:08:14
    Author     : volal
--%>
                ...
                <div class="carousel-caption"  style="justify-content: center; background: #99ddff; border-radius: 20px; box-shadow: 0 5px #1188cc; padding-top: 60px;">
                    ...
                    <div class="container mt-5" style="justify-content: center;">
                        <form action="doctor.do" method="post" id="rpCitCanceladas" name="rpCitCanceladas">
                                ...
                                <div class="col-md-6" style="justify-content: center; ">
                                    <table style="width: 500px; text-align: center; position: relative; transform: translateX(-100px); border-radius: 20px;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="background: #0f2778; color: #e4e4e4; width: 20px;">Diagnóstico</td>
                                            <td style="background: #0f2778; color: #e4e4e4; width: 20px;">No. de cita</td>
                                            <td style="background: #0f2778; color: #e4e4e4; width: 20px;">Alergias</td>
                                            <td style="background: #0f2778; color: #e4e4e4; width: 20px;">Fecha</td>
                                        </tr>
                                        <%
                                            ...
                                            while(rsDoc.next()){
                                                ...
                                                out.println("<td style='text-align:center;'>"+rsDoc.getString(5)+"</td>");
                                                out.println("<td style='text-align:center;'>"+rsDoc.getString(7)+"</td></tr>");
                                            }
                                            }
                                            g = 1;
                                        %>
                            ...
                            <input type="hidden" id="origen" name="origen" value="errepeCitCanceladas">
                        </form>
                    </div>
                </div>
            </div>
