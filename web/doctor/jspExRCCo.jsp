<%-- 
    Document   : jspExRCCo
    Created on : 24-oct-2019, 12:47:31
    Author     : volal
--%>
...
<%  
    ...
    rsFrm=con.mostrarCConfirmadas(id);
    ...
    try{
        ...
        row.createCell(2).setCellValue("Diagnóstico");
        row.createCell(3).setCellValue("No. de cita");
        ...
        while(rsFrm.next()){
            ...
            row1.createCell(5).setCellValue(rsFrm.getString(7));
            i=i+1;
